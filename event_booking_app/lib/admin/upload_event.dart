        ...
        child: ListView(
          children:[ Column(
            ...
            children: [
              ...
              Center(
                child: selimage !=null?Container(
                   decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(30)),
                  child: Image.file(selimage!,height: 150,width: 150,fit: BoxFit.cover,)):
                Center(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      width: 150,
                      decoration: BoxDecoration(
                        border: Border.all(color: Color.fromARGB(255, 23, 20, 97), width: 2),
                        borderRadius: BorderRadius.circular(30),
                      ),
                      child: Icon(Icons.camera_alt, size: 50, color: Color.fromARGB(255, 23, 20, 97))),
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: eventcategories.map<DropdownMenuItem<String>>((String category) {
